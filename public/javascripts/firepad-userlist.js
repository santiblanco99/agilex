var FirepadUserList = (function() {
  ...
  FirepadUserList.prototype.makeHeading_ = function() {
   ...
   // ref_.child(this.userId_).child('color').remove();
    return elt('div', [
      elt('span', 'COMPARTIDO CON '),
      counterSpan,
      elt('span', ' USUARIOS')
  ...
  // var nameInput = elt('input', null, { type: 'text', 'class': 'firepad-userlist-name-input'} );
   ...
   var nameHint = elt('div', this.displayName_, { 'class': 'firepad-userlist-name'} );
